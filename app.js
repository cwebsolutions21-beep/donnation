...
document.addEventListener('DOMContentLoaded', () => {
    ...
    formDonate.addEventListener('submit', (e) => {
        ...
        // Show the pay page for both mobile and desktop.
        // On mobile the UPI app buttons will launch the native app.
        // User pays, comes back, then clicks "I Have Completed Payment".
